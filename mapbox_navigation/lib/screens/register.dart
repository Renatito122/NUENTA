...
class _RegisterPageState extends State<RegisterPage> {
  ...
  Future<void> function(username, password, email, phone) async {
    ...
    var _collectionRef =
        FirebaseFirestore.instance.collection('users').doc('map').update({
      uid: {
        'username': username,
        'password': password,
        'email': email,
        ...
        children: [
          ...
          Container(
            ...
            margin: EdgeInsets.symmetric(
                ...
                horizontal: screenWidth / 12), // EdgeInsets
            child: Column(
              ...
              children: [
                ...
                confirmPassField(
                    "Confirm your password", confirmPassController, true),
                TextButton(
                  onPressed: () {
                    if (idController.text.length != 0 &&
                      ...
                      function(idController.text, passController.text,
